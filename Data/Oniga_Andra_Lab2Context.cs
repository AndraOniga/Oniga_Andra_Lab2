...
namespace Oniga_Andra_Lab2.Data
{
    public class Oniga_Andra_Lab2Context : DbContext
    {
        ...
        public DbSet<Oniga_Andra_Lab2.Models.Category> Category { get; set; }

        public DbSet<Oniga_Andra_Lab2.Models.Member> Member { get; set; }

        public DbSet<Oniga_Andra_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
